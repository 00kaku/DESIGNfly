...
class DESIGNIFY {
	...
	public function setup_theme() {
		...
		load_theme_textdomain( 'designify', DESIGNIFY_TEMP_DIR . '/languages' );
	...
	public function add_read_more_link() {
		...
		return sprintf( '<a class="moretag" href="%s">%s</a>', get_permalink( $post->ID ), esc_html__( 'Read More', 'designify' ) );
	}
