...
namespace DESIGNIFY\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( DESIGNIFY_TEMP_DIR ), $directory, $file_name );
...
spl_autoload_register( '\DESIGNIFY\Inc\Helpers\autoloader' );
